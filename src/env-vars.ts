...
const DEFAULT_LRU_CACHE_SIZE_TAG             = 5000
const DEFAULT_LRU_CACHE_SIZE_TAG_GROUP       = 500
const DEFAULT_LRU_CACHE_SIZE_WXXD_PRODUCT    = 100
const DEFAULT_LRU_CACHE_SIZE_WXXD_ORDER      = 100
const DEFAULT_LRU_CACHE_SIZE_CALL            = 100
...
const WECHATY_PUPPET_LRU_CACHE_SIZE_TAG = (v?: number) => v ?? getNumber(
  'WECHATY_PUPPET_LRU_CACHE_SIZE_TAG',
  DEFAULT_LRU_CACHE_SIZE_TAG,
)

const WECHATY_PUPPET_LRU_CACHE_SIZE_TAG_GROUP = (v?: number) => v ?? getNumber(
  'WECHATY_PUPPET_LRU_CACHE_SIZE_TAG_GROUP',
  DEFAULT_LRU_CACHE_SIZE_TAG_GROUP,
)

const WECHATY_PUPPET_LRU_CACHE_SIZE_WXXD_PRODUCT = (v?: number) => v ?? getNumber(
  'WECHATY_PUPPET_LRU_CACHE_SIZE_WXXD_PRODUCT',
  DEFAULT_LRU_CACHE_SIZE_WXXD_PRODUCT,
)

const WECHATY_PUPPET_LRU_CACHE_SIZE_WXXD_ORDER = (v?: number) => v ?? getNumber(
  'WECHATY_PUPPET_LRU_CACHE_SIZE_WXXD_ORDER',
  DEFAULT_LRU_CACHE_SIZE_WXXD_ORDER,
)

const WECHATY_PUPPET_LRU_CACHE_SIZE_CALL = (v?: number) => v ?? getNumber(
  'WECHATY_PUPPET_LRU_CACHE_SIZE_CALL',
  DEFAULT_LRU_CACHE_SIZE_CALL,
)
...
export {
  ...
  WECHATY_PUPPET_LRU_CACHE_SIZE_WXXD_ORDER,
  WECHATY_PUPPET_LRU_CACHE_SIZE_CALL,
  WECHATY_PUPPET_DISABLE_LRU_CACHE,
}
